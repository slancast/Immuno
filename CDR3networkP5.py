...
filehandle=open("../IMGTIgG/5IgGT1/5_AA-sequences.txt", "r")
a = None
...
filehandle=open("../IMGTIgG/5IgGT2/5_AA-sequences.txt", "r")
a = None
...
nx.write_gml(G,"./P5CDR3/P5CDR3T2.gml.gz")

pos = nx.fruchterman_reingold_layout(G)
with open("./P5CDR3/P5CDR3T2graphLayout.txt", 'wb') as f:
    pickle.dump(pos, f)
...
plt.savefig("./P5CDR3/networkxgraphlargeP5T2.pdf")
plt.clf()
...
plt.savefig("./P5CDR3/T2Subgraph.pdf")
plt.clf()
...
plt.savefig("./P5CDR3/T2ConnectedCommunities.pdf")
plt.clf()
...
plt.savefig("./P5CDR3/T2SubgraphNewLayout.pdf")
plt.clf()
...
filehandle=open("../IMGTIgG/5IgGT3/5_AA-sequences.txt", "r")
a = None
...
nx.write_gml(G,"./P5CDR3/P5CDR3T3.gml.gz")

pos = nx.fruchterman_reingold_layout(G)
with open("./P5CDR3/P5CDR3T3graphLayout.txt", 'wb') as f:
    pickle.dump(pos, f)
...
plt.savefig("./P5CDR3/networkxgraphlargeP5T3.pdf")
plt.clf()
...
plt.savefig("./P5CDR3/T3Subgraph.pdf")
plt.clf()
...
plt.savefig("./P5CDR3/T3ConnectedCommunities.pdf")
plt.clf()
...
plt.savefig("./P5CDR3/T3SubgraphNewLayout.pdf")
plt.clf()
