...
print("T1")
IgET1 <- readChangeoDb(paste("../../P",Subject,"_IgE_T1_db-pass_clone-pass_germ-pass.tab",sep=""))
ID <- c()
Isotype <- c()
for (i in 1:nrow(IgET1))  { ID <- append(ID,paste(Subject,"T1",sep="")) }
IgET1 <- cbind(IgET1, ID)

print("T2")
IgET2 <- readChangeoDb(paste("../../P",Subject,"_IgE_T2_db-pass_clone-pass_germ-pass.tab",sep=""))
ID <- c()
Isotype <- c()
for (i in 1:nrow(IgET2))  { ID <- append(ID,paste(Subject,"T2",sep="")) }
IgET2 <- cbind(IgET2, ID)

print("T3")
IgET3 <- readChangeoDb(paste("../../P",Subject,"_IgE_T3_db-pass_clone-pass_germ-pass.tab",sep=""))
ID <- c()
Isotype <- c()
for (i in 1:nrow(IgET3))  { ID <- append(ID,paste(Subject,"T3",sep="")) }
IgET3 <- cbind(IgET3, ID)


db <- rbind(IgET1, IgET2, IgET3)
