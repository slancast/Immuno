...
T1_props <- aminoAcidProperties(IgGT1, seq="JUNCTION", nt=TRUE, trim=TRUE, label="CDR3")
...
T2_props <- aminoAcidProperties(IgGT2, seq="JUNCTION", nt=TRUE, trim=TRUE, label="CDR3")
...
T3_props <- aminoAcidProperties(IgGT3, seq="JUNCTION", nt=TRUE, trim=TRUE, label="CDR3")
...
write.table(aa_length, file = paste(Subject,"IgGaa_length.csv",sep=""), row.names = Subject, col.names = FALSE, sep=",")
write.table(aa_gravy, file = paste(Subject,"IgGaa_gravy.csv",sep=""), row.names = Subject, col.names = FALSE, sep=",")
write.table(aa_basic, file = paste(Subject,"IgGaa_basic.csv",sep=""), row.names = Subject, col.names = FALSE, sep=",")
write.table(aa_acidic, file = paste(Subject,"IgGaa_acidic.csv",sep=""), row.names = Subject, col.names = FALSE, sep=",")
